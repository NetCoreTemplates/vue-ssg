...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    MdiCheckOu: typeof import('~icons/mdi/check-ou')['default']
    MdiCheckOutline: typeof import('~icons/mdi/check-outline')['default']
    ...
    MdiJamstackIcon: typeof import('~icons/mdi/jamstack-icon')['default']
    MdiShieldAccount: typeof import('~icons/mdi/shield-account')['default']
    MdiTrashCanIconOutline: typeof import('~icons/mdi/trash-can-icon-outline')['default']
